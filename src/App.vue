<template>
  ...
  <div >
    ...
    <div class="bd-pageheader">
      <div class="container">
        <h1>Ooyala Player Skin Configurator</h1>
        <p class="lead">Welcome! Configure our new player skin below. This page allows you to modify the player skin and download skin.json file.</p>
      </div>
    </div>
    <div id="one">
      <tabs>
